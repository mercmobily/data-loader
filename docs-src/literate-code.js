...
//      to comply to the server. It receives both the URL, and whatever would possibly be needed to make up that URL
//      if the developers have specific requirements.
